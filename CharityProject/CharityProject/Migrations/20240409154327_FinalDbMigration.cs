        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Charities_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Charities_Owners_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Update_Charities_CharityId",
                        column: x => x.CharityId,
                        principalTable: "Charities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0c2345fb-a0eb-4771-9901-2b2648f745ad"), "Helping Poor" },
                    { new Guid("39c69eb7-7a5f-49a9-b8c0-52e1a188c563"), "Healthy Food" },
                    { new Guid("6088dda6-fa21-40c8-81fd-96e6208afe1e"), "Medical Facilities" },
                    { new Guid("8f302450-8add-46fd-89fb-e18b15ffd430"), "Clean Water" },
                    { new Guid("c0189056-ff44-4730-8db9-c0240c8d22b5"), "Free Education" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Charities_CategoryId",
                table: "Charities",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Charities_CreatorId",
                table: "Charities",
                column: "CreatorId");
